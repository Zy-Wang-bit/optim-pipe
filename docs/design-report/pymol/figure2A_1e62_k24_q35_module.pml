...
#   pymol figure2A_1e62_k24_q35_module.pml
reinitialize
set retain_order, 1
...
select seed_pair, e62 and chain B and resi 24+35
select rescue_pair, e62 and chain B and resi 27+36
select local_context, e62 and chain B and resi 31+32+33+34+38
select site_focus, seed_pair or rescue_pair or local_context

color orange, seed_pair
color forest, rescue_pair
color gray55, local_context
show sticks, byres (seed_pair or rescue_pair)
show spheres, (seed_pair or rescue_pair or local_context) and name CA
...
label e62 and chain B and resi 27 and name CA, "Q27"
