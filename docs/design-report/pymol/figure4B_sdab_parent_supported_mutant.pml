...
#   pymol figure4B_sdab_parent_supported_mutant.pml
reinitialize
set retain_order, 1
...
load structures/sdab_interface/01_plausible_best_parent_supported_29c7309149.cif, cand
...
select cand_mut_sites, cand and chain A and resi 72+100+111
...
color forest, cand_ag_iface
color forest, cand_ab_iface
color yellow, cand_mut_sites

label cand and chain A and resi 100 and name CA, "Q100H"
label cand and chain A and resi 111 and name CA, "Y111E"
